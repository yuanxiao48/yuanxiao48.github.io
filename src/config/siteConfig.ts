...
const settings = userSettings as {
	...
	theme: {
		hue: number;
		defaultMode: SiteConfig["themeColor"]["defaultMode"];
	};
	pages: {
		friends: boolean;
		sponsor: boolean;
...
export const siteConfig: SiteConfig = {
	...
	navbar: {
		...
		logo: {
			type: "icon",
			value: "material-symbols:edit-note",
			alt: "Blog",
		},
		// 导航栏标题
		title: settings.site.title,
	...
	pages: {
		// 友链页面开关
		friends: settings.pages.friends,
		// 打赏页面开关
		sponsor: settings.pages.sponsor,
		// 留言板页面开关，需要配置评论系统
		guestbook: settings.pages.guestbook,
		// 番组计划页面开关，含追番、游戏、书籍和音乐
		bangumi: settings.pages.bangumi,
		// 相册页面开关
		gallery: settings.pages.gallery,
	},
